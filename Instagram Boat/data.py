...
for i in ids:
    browser.get("https://www.instagram.com/aman___mistry/")
    login_link = browser.find_element_by_class_name("sqdOP")
    login_link.click()
    ...
    try:
        ...
        pass
    # browser.find_element_by_xpath("//button[@type='submit']").click()
    browser.find_element_by_class_name("nZSzR").find_element_by_xpath("//button[text()='Follow']").click()
